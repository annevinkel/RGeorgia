...
- Part C: `R` Functionality and reading in data
    ...
    <!-- - [Practical C with solutions](Contents/Material/Part C - R-functionality/Practical_C.html) -->
    <!-- - [`cabinet.txt`](Contents/Material/Part C - R-functionality/cabinet.txt) -->
...
### Materials
- Part D: Data manipulation and basic statistics
    <!-- - [Lecture D](Contents/Material/Part F - Pipes/Lecture_F.html) -->
    <!-- - [Practical D](Contents/Material/Part F - Pipes/Practical_F_walkthrough.html) -->
    <!-- - [Impractical D](Contents/Material/Part F - Pipes/Practical_F.html) -->
